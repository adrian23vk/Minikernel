/* IMPORTANTE: Los alumnos Marta Fernandez de la Mela Salcedo y Adrian Morillas Marcos incluyen
 * este archivo en su entrega como alternativa para probar las operaciones de lock y unlock.
 * Solo difiere del original en que los procesos "mutex1" y "mutex2" se crean al inicio del programa, 
 * ya que crearlos tras una operacion de lock daba una expecion de memoria al crear la imagen del proceso.
 * Se ofrecen mas detalles en la memoria. */
